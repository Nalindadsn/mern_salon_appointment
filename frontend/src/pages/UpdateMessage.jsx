          ...
          <Row gutter={20}>
            <Col xs={24} md={24} lg={24}>
              <Form.Item
                ...
                required
                rules={[
                  { required: true, message: "Message first name is required" },
                ]}
              >
            ...
            <Col xs={24} md={24} lg={24}>
              <Form.Item
                ...
                required
                rules={[
                  { required: true, message: "Message last name is required" },
                ]}
              >
                <Input type="text" placeholder="Message Name" />
              </Form.Item>
            ...
            <Col xs={24} md={24} lg={24}>
              <Form.Item
                ...
                required
                rules={[
                  { required: true, message: "Message email is required" },
                ]}
              >
                <Input type="text" placeholder="Message Name" />
              </Form.Item>
